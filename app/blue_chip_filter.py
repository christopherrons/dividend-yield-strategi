...
class BlueChipFilter:
    ...
    def is_applicable_symbol(self, start_date: str, end_date: str, ticker_item: TickerDataItem):
    ...
    def is_dividend_stock(self, ticker_item: TickerDataItem):
    ...
    def is_uninterrupted_dividends(self, start_date: str, end_date: str, ticker_item: TickerDataItem):
    ...
    def is_dividends_increasing_n_times(self, ticker_item: TickerDataItem):
        dividend: Series = ticker_item.get_dividend()
    ...
    def has_minimum_nr_of_outstanding_shares(self, ticker_item: TickerDataItem):
    ...
    def has_minimum_nr_of_institutional_investors(self, ticker_item: TickerDataItem):
    ...
    def is_earnings_increasing_n_times(self, ticker_item: TickerDataItem):
        # FIXME
        return True
